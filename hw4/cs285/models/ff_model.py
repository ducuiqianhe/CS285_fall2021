...
class FFModel(nn.Module, BaseModel):
    ...
    def forward(
        ...
        next_obs_pred = ptu.to_numpy(delta_pred_normalized)*delta_std + obs_unnormalized + delta_mean
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        """
        prediction, temp_var = self(obs, acs, **data_statistics)
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        temp_var1, pred_normalized = self(observations, actions, **data_statistics)
